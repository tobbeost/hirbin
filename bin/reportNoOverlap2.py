...
def parseArgsCC():
  ...
  '''
  parser = argparse.ArgumentParser(description='Read an annotation file and report only the best hit for non-overlapping sequences')
  parser.add_argument('-a', dest='annotation_file', help='The path to the annotation file (required)',required=True)
  parser.add_argument('-o', dest='output_file', help='The name of the output file (required)',required=True)
...
def main(annot_filename,output_filename,tentacle_format,max_acceptable_overlap):
...
if __name__=='__main__':
  ...
  main(arguments.annotation_file,arguments.output_file,arguments.tentacle_format,arguments.max_acceptable_overlap)